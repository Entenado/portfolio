...
import perfil from "../assets/perfile.png";
      ...
      <div className={styles.homeContent}>
        ...
        <div className={styles.homeText}>
          ...
          <motion.h2
            ...
            transition={{ delay: 0.5, duration: 1 }} // Retraso y duración de la animación
          >
            <span className={styles.span}>Soy</span> Abel Fucili
          </motion.h2>
          ...
          >
            Soy un <span className={styles.resalt}>desarrollador fullstack-java</span> con
            gran pasión en crear soluciones escalables y robustas. Aquí encontrarás un poco más{" "}
